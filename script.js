...
(function () {
  ...
  // Codeforces — Official public API (Commented out as not in Satish's CV)
  /*
  ...
  */
  ...
  // LeetCode — via alfa-leetcode-api proxy
  fetch('https://alfa-leetcode-api.onrender.com/Satishkumara3/contest')
    .then(r => r.json())
    .then(data => {
